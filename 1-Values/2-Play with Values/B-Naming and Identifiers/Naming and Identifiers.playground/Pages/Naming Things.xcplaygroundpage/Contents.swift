 ...
 */
let number0fDogs = 8 + 2

let number0fCats = 4 - 1

let number0fTurtles = 3 + 1

let numberOfHamster = 2 + 1

let totalNumber0fAnimals = number0fDogs + number0fCats + number0fTurtles + numberOfHamster

let totalNumber0fMammals = number0fDogs + number0fCats + numberOfHamster
