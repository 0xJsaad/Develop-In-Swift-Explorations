...
//“Today was a big day for <name>. They had finally saved up <number> dollars and were going to buy a <adjective> <noun>. They went to the <noun> <place> feeling very <positive emotion>. But then they felt <negative emotion>. They were all out of <noun>!”
let kidsName = " Steve & Jobs"
let amountSaved = 1000
let adjectiveBuying = " red"
let nounBuying = " Apple computer"
let nounPlace = " big"
let place = " Apple store"
let positiveFeeling = " excited"
let negativeFeeling = " anxious"
let myStorieString = "Today was a big day for \(kidsName). They had finally saved up \(amountSaved) $$ dollars and were going to buy a \(adjectiveBuying) \(nounBuying). They went to the \(nounPlace) \(place) feeling very \(positiveFeeling). But then they felt \(negativeFeeling). They were all out of \(nounBuying)."
/*:
