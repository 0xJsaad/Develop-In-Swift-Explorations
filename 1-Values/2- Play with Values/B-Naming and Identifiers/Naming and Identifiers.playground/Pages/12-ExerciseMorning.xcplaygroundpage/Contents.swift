...
let totalTimeInRoutine = brushTeeth + fixBed + takeShower + makeBreakfast + goJogging + readNews
/*:
 ...
 */
let totalOfRoutineMandatoryWork = brushTeeth + takeShower + fixBed + makeBreakfast
let totalOfMinEnjoingRoutine = takeShower + goJogging + readNews
/*:
 ...
 */
let totalTime = brushTeeth + fixBed + takeShower + makeBreakfast + goJogging + readNews


print("The total time spent getting ready now is", (totalTime),"minutes")
/*:
